...
const CreateListing = (props) => {
  ...
  const newListing = async () => {
    ...
    try {
      ...
      alert('Error in creating listing');
    }
  }
    ...
    <>
      <div className='create-listing-page'>
        ...
        {amenities.map((x, index) => (
          <div key={index} >
            <div>
              <TextField label='Amenity' type="text" value={x.input} placeholder="Property Amenities" onChange={(e) => handleAmenities(e, index)} required/>
        ...
        <br />
        <Button color="success" variant='outlined' onClick={newListing}>Create New Listing</Button>
